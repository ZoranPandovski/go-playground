...
func MountBottleController(service *goa.Service, ctrl BottleController) {
	...
	service.Mux.Handle("GET", "/bottles/:id", ctrl.MuxHandler("show", h, unmarshalShowBottlePayload))
...
// unmarshalShowBottlePayload unmarshals the request body into the context request data Payload field.
func unmarshalShowBottlePayload(ctx context.Context, service *goa.Service, req *http.Request) error {
	payload := &bottlePayload{}
	if err := service.DecodeRequest(req, payload); err != nil {
		return err
	}
